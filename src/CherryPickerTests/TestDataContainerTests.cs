    ...
    public class TestDataContainerTests
    {
        ...
        public void AllValueTypesDefaultTest()
        {
            _container.For<AllValueTypesClass>(x => x
                ...
                .Default(p => p.IntArray).To(new int[] { 1 })
                .Default(p => p.NullIntArray).To(new int?[] { 2 })
                .Default(p => p.ShortArray).To(new short[] { 3 })
                .Default(p => p.NullShortArray).To(new short?[] { 4 })
                .Default(p => p.BoolArray).To(new bool[] { true })
                .Default(p => p.NullBoolArray).To(new bool?[] { false })
                .Default(p => p.ByteArray).To(new byte[] { 5 })
                .Default(p => p.NullByteArray).To(new byte?[] { 6 })
                .Default(p => p.CharArray).To(new char[] { 'a' })
                .Default(p => p.NullCharArray).To(new char?[] { 'b' })
                .Default(p => p.DecimalArray).To(new decimal[] { 1.5M })
                .Default(p => p.NullDecimalArray).To(new decimal?[] { 2.5M })
                .Default(p => p.DoubleArray).To(new double[] { 3.5D })
                .Default(p => p.NullDoubleArray).To(new double?[] { 4.5D })
                .Default(p => p.MyEnumArray).To(new MyEnum[] { MyEnum.Value1 })
                .Default(p => p.NullMyEnumArray).To(new MyEnum?[] { MyEnum.Value2 })
                .Default(p => p.FloatArray).To(new float[] { 5.5F })
                .Default(p => p.NullFloatArray).To(new float?[] { 6.5F })
                .Default(p => p.LongArray).To(new long[] { 7 })
                .Default(p => p.NullLongArray).To(new long?[] { 8 })
                .Default(p => p.SByteArray).To(new sbyte[] { 9 })
                .Default(p => p.NullSByteArray).To(new sbyte?[] { 10 })
                .Default(p => p.UIntArray).To(new uint[] { 11 })
                .Default(p => p.NullUIntArray).To(new uint?[] { 12 })
                .Default(p => p.ULongArray).To(new ulong[] { 13 })
                .Default(p => p.NullULongArray).To(new ulong?[] { 14 })
                .Default(p => p.UShortArray).To(new ushort[] { 15 })
                .Default(p => p.NullUShortArray).To(new ushort?[] { 16 })
                .Default(p => p.StringArray).To(new string[] { "A String" }));
